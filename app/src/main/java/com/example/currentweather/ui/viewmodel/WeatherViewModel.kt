    ...
    fun onViewEvent(mainWeatherEvent: MainWeatherEvent) {
        ...
        when (mainWeatherEvent) {
            is MainWeatherEvent.FetchWeather -> {
                ...
                if (mainWeatherEvent.unitSystem == UnitSystem.IMPERIAL) {
                    Log.i(TAG, "onViewEvent: Loading Imperial Data")
                    loadImperialWeatherData(mainWeatherEvent.params)

                } else if (mainWeatherEvent.unitSystem == UnitSystem.METRIC) {
                    Log.i(TAG, "onViewEvent: Loading Metric Data")
                    loadMetricWeatherData(mainWeatherEvent.params)
